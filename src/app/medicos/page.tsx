              ...
              >
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="relative h-16 w-16 rounded-2xl overflow-hidden bg-gradient-to-tr from-primary to-secondary flex items-center justify-center text-white font-bold text-2xl shadow-lg shrink-0">
                    ...
                    {doctor.is_online_now && (
                      <span className="absolute bottom-1 right-1 h-3.5 w-3.5 bg-green-500 border-2 border-black rounded-full shadow-[0_0_10px_rgba(34,197,94,0.8)] animate-pulse" title="Disponível agora" />
                    )}
                  </div>
                  <div className="flex-1 min-w-0 pr-16">
                    <h3 className={`text-lg font-bold transition-colors truncate flex items-center gap-2 ${
                      doctor.is_online_now
